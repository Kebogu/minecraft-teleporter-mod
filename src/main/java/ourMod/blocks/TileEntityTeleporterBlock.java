...
public class TileEntityTeleporterBlock extends TileEntity implements ITickable, IInventory
{
	...
	public String getName() {
		...
		return this.hasCustomName() ? this.customName: "container.teleporter_block";
	}
	...
	{	
		...
		if(!this.world.isRemote)
		{
			...
			{
				flag1 = true;
				TeleBlock.setState(this.isBurning(), this.world, this.pos);
			}
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = TeleBlockRecipes.getInstance().getTeleBlockResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem()
	{
		if(this.canSmelt())
		{
			...
			ItemStack result = TeleBlockRecipes.getInstance().getTeleBlockResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
...
} //watch out for this bracket once you include the rest of the code
...
//	{
//		return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.Teleporter_Block");
//	
...
//			{
//				ItemStack output = TeleBlockRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
//				if(!output.isEmpty())
//				{
//					smelting = output;
//					cookTime++;
